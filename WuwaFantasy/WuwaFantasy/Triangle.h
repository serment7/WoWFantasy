...
struct TextureTriangle
{
	...
	TextureTriangle(const D3DXVECTOR3& v1,
...
struct NormalTriangle
{
	...
	NormalTriangle(const FVF_PositionNormal& v1,
	...
	NormalTriangle(const D3DXVECTOR3& v1,
		const D3DXVECTOR3& v2,
		const D3DXVECTOR3& v3,
...
struct TextureNormalTriangle
{
	...
	TextureNormalTriangle(const FVF_PositionNormalTexture& v1,
	...
	TextureNormalTriangle(const D3DXVECTOR3& v1,
		const D3DXVECTOR3& v2,
		const D3DXVECTOR3& v3,
		const D3DXVECTOR2& uv1,
		const D3DXVECTOR2& uv2,
