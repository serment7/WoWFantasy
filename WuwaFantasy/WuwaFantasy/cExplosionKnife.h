...
public:
	cExplosionKnife(cGameObject* _pOwner,const float& _distance,const float& _attackTiming,const float& _fAniTime, cGameObject* _pThrown);
	virtual ~cExplosionKnife();
