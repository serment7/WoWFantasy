...
void cObject::Update()
{
	...
	if (m_bCalcHeight)
	{
		...
		{
			maps[i]->CalcTerrainHeight(m_vPos.x, &m_vPos.y, m_vPos.z);
		}
	}
...
void cObject::SetUseAngle(bool _bUseAngle)
{
	m_bUseAngle = _bUseAngle;
}

void cObject::SetCalcHeight(bool _bCalcHeight)
{
	m_bCalcHeight = _bCalcHeight;
}
